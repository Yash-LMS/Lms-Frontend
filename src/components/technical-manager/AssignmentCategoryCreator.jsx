...
import { FIND_ASSIGNMENT_CATEGORY, CREATE_ASSIGNMENT_CATEGORY_URL } from '../../constants/apiConstants';

const AssignmentCategoryCreator = ({fetchAllCategories}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsLoading(true);
      const response = await axios.post(`${CREATE_ASSIGNMENT_CATEGORY_URL}`, {
      ...
      if (response.data.response === 'success') {
        showMessage('success', 'Assignment category added successfully!');
        setTimeout(() => {
          handleCloseModal();
        }, 2000);
        fetchAllCategories();
      } else {
        showMessage('error', `Failed to add assignment category: ${response.data.message || 'Unknown error'}`);
      }
    } catch (error) {
      console.error('Error creating assignment category:', error);
      showMessage('error', 'An error occurred while creating the assignment category');
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modal}>
            <div className={styles.modalHeader}>
              <h2>Create New Assignment Category</h2>
              <button 
              ...
              <form onSubmit={handleSubmit}>
                ...
                {inputMode === 'manual' ? (
                  <div className={styles.formGroup}>
                    ...
                    <input
                      ...
                      placeholder="Enter assignment category name"
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    placeholder="Enter assignment sub-category name"
                    className={styles.input}
                    required
                  />
                </div>
...
export default AssignmentCategoryCreator;