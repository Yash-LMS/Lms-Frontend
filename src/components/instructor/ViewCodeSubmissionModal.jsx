...
import EvaluationModal from './EvaluationModal'; // Import the new modal
...
const ViewCodeSubmissionModal = ({ taskId, onClose, isOpen }) => {
  ...
  // State for EvaluationModal
  const [evaluationModalOpen, setEvaluationModalOpen] = useState(false);
  const [selectedAllotmentId, setSelectedAllotmentId] = useState(null);
  const [selectedMaxScore, setSelectedMaxScore] = useState(null);
  ...
  // Handle evaluate action - opens evaluation modal
  const handleEvaluate = (allotmentId, maxMarks) => {
    setSelectedAllotmentId(allotmentId);
    setSelectedMaxScore(maxMarks);
                        ...
                        <td className={styles.actions}>
                          {showEvaluateButton(submission) && (
                            <button 
                              ...
                              onClick={() => handleEvaluate(submission.allotmentId, submission.maxMarks)}
                            >
                              Evaluate
                            </button>
                          )}
